...
public class PersonServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        /*
        Die Felder der Adresse setzen. Eine persistente Person wird mit Adresse 
        geladen, eine neue Person hat ein leeres Adresse-Objekt als Default. In
        beiden Fällen sind keine null-Werte zu erwarten.
        */
        p.getAdresse().setStrasse(request.getParameter("strasse"));
        p.getAdresse().setHausnummer(request.getParameter("hausnr"));
        p.getAdresse().setPlz(request.getParameter("plz"));
        p.getAdresse().setOrt(request.getParameter("ort"));
        try {
