package de.kaiguenster.javaintro.rechenservlet;
...
/**
 * Servlet-Implementierund, die 2 Zahlen als Parameter entgegennimmt und addiert
 * @author Kai
 */
@WebServlet(name = "Rechenservlet", urlPatterns = {"/rechne"})
public class Rechenservlet extends HttpServlet {
