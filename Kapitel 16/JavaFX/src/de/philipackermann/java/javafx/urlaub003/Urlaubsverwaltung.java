package de.philipackermann.java.javafx.urlaub003;
...
public class Urlaubsverwaltung extends Application {
	...
	public void start(Stage stage) throws Exception {
        ...
        tabNeuerUrlaubsantrag.setId("tabNeuerUrlaubsantrag");
        tabUrlaubsantraege.setId("tabUrlaubsantraege");
        textFieldVorname.getStyleClass().add("important");
        textFieldNachname.getStyleClass().add("important");
        scene.getStylesheets().add("de/philipackermann/java/javafx/urlaub003/Urlaubsverwaltung.css");
